...
function createNewTaskDefJson() {
    ...
    NEW_DEF_JQ_FILTER="family: .family, volumes: .volumes, containerDefinitions: .containerDefinitions, memory: .memory, cpu: .cpu, compatibilities: .compatibilities, requiresCompatibilities: .requiresCompatibilities"
