...
declare module 'bn.js' {
  ...
  type ArrayCtor = typeof Array;
  type BufferCtor = typeof Buffer;
  type ArrayType = ArrayCtor | BufferCtor;
  ...
  class BN {
     ...
     */
    toArrayLike<T extends ArrayType>(
      type: T,
      endian?: Endianness,
      length?: number,
    ): T extends BufferCtor ? Buffer : Array<any>;
